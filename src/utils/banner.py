...
def print_banner(console, base_path=None):
    ...
    console.print("  [bold]'/make map load'[/bold] - Load existing .makemap file into context")
    console.print("  [bold]'/make map update'[/bold] - Update existing .makemap with new targets")
